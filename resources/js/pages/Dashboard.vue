      ...
      <el-table :data="metrics.eventos_roi" border stripe style="width: 100%">
        ...
        <el-table-column label="Ingresos" width="150" align="right">
          <template #default="{ row }">
            <span style="color: #67C23A; font-weight: bold;">+${{ row.ingresos.toFixed(2) }}</span>
          </template>
        </el-table-column>
        <el-table-column label="Gastos" width="150" align="right">
          <template #default="{ row }">
            <span style="color: #F56C6C;">-${{ row.gastos.toFixed(2) }}</span>
          </template>
        </el-table-column>
        <el-table-column label="Neto" width="150" align="right">
          <template #default="{ row }">
